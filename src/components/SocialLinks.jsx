...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/syahjuddin-azra-53a4411a2/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@syahjuddinazra17",
    icon: Instagram,
    url: "https://www.instagram.com/syahjuddinazra17/",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@Syahjuddin Azra",
    icon: Youtube,
    url: "https://www.youtube.com/syahjudinazra",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@SyahjudinAzra",
    icon: Github,
    url: "https://github.com/syahjudinazra",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://tiktok.com/syahjudinazra",
    color: "black",
